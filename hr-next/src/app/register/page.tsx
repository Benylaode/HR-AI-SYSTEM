    ...
    <div className="min-h-screen bg-gradient-to-br from-[#002D40] via-[#004D5A] to-[#003D4A] flex items-center justify-center p-4 md:p-8">
      ...
      <div className="relative w-full max-w-5xl flex flex-col lg:flex-row bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl border border-white/20 z-10">
        ...
        <div className="hidden lg:flex lg:w-1/2 p-8 lg:p-12 flex-col justify-between relative overflow-hidden bg-[#0A1A2F]">
          ...
          <div className="relative z-10 my-10 lg:my-0">
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight drop-shadow-md">
              Registrasi <br/>
              <span className="text-teal-400">Akun HR</span>
            </h1>
            <p className="text-blue-100/80 text-lg font-light max-w-md border-l-4 border-teal-500 pl-4">
              HR Recruitment System<br/>
              <span className="text-sm opacity-70">Akses Platform Manajemen Kandidat</span>
            </p>
          </div>
        ...
        <div className="lg:w-1/2 p-8 lg:p-12 bg-white w-full">
          ...
          {/* Back Link */}
          <Link href="/" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-teal-600 mb-6 transition-colors">
            <ArrowLeft size={16} />
            Kembali ke Login
          </Link>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 mt-1">Isi data berikut untuk mendaftar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-teal-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500/20 transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-teal-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-teal-500/20 transition-all pr-12"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 text-white py-4 px-6 font-bold rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2 uppercase tracking-wider shadow-lg shadow-teal-500/25 mt-6"
            >
              {loading ? (
                <>
